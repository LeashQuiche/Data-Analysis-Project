...
# assignCentroids function takes in an array of normalized x (hemoglobin) and y (glucose) values from the CSV file 
# and the randomly generated array of centroids from randomCentroids. 
