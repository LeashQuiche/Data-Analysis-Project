...
# Functions
# =================================================================================================
# kNearestNeighbor inputs a numpy array, a random point, and an integer k and returns an array of
# length k which holds the indices of the k number of nearest points to the test case.
...
# kNNC class takes in an 2 arrays. One of the data and the other is a list of indices.
