...
# a) adds them to an inputted array with a classification from findDistance or
# b) returns the two points for the user to decide what to do.
def createTestCase(array):
    return array

# graphTestCase void function takes in a 2D numpy array (and a cartesian 
...
def graphTestCase(array):
    return

# mainDriver function will graph both the orginial CSV file and the test case.
